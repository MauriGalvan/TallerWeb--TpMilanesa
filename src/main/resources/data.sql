...
('Tortas fritas', 20.0, 'merienda', 'https://i.postimg.cc/NMs9s0nP/foto-ilustrativa.jpg', 'Harina, Agua, Sal, Levadura, Azúcar, Aceite', 'Un clásico de la merienda, crujientes y deliciosas.', 'Mezcla la harina, el agua, la sal, el azúcar y la levadura hasta formar una masa. Amasa y deja reposar 10 minutos. Divide en porciones y estira en forma de discos. Fríe en aceite caliente hasta dorar. Escurre y sirve caliente.'),

('Panqueques', 15.0, 'desayuno', 'https://i.postimg.cc/Pq1zy6yv/como-hacer-panqueques-esponjosos-la-receta-facil-y-economica.png', 'Harina, Leche, Huevos, Azúcar, Mantequilla, Sal', 'Suaves y esponjosos, perfectos para el desayuno.', 'Mezcla la harina, leche, huevos, azúcar y sal hasta obtener una masa homogénea. Calienta una sartén con mantequilla y vierte un poco de masa. Cocina hasta que estén dorados y voltea. Sirve con miel o mermelada.'),
